      ...
      <div className={`${showmenu ? "inside-screen" : "rm"}`}>
        <div className="menu-list">
          <div className="notification-panel">
            <span className="noty-text">IPOD PROJECT</span>
      ...
      <div className="cont">
          ...
          <div className="content">
            ...
            <div className="description">
              ...
              <div className="artist">
                {" "}
                <span>Composed by</span> THE CHAINSMOKERS{" "}
              </div>
            </div>
          </div>
        ...
        <div className={`${settings ? "setting" : "rm"}`}>
          <div className="st_cont">
            ...
            <div className="ipod">IPOD PROJECT</div>
          </div>

          <div className="text">MADE BY ANSHU SAURABH</div>
        </div>
      </div>
    </div>
  );
